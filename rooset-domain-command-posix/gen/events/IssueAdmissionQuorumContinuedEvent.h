...
namespace rooset {
  ...
  class IssueAdmissionQuorumContinuedEvent : public ProjectEvent<Document>
  {
  private:
  ...
  public:
    ...
    const uuid id;
        ...
        IssueAdmissionQuorumContinuedEvent(
            uuid id) :
            id(id)
        {}
        ...
        IssueAdmissionQuorumContinuedEvent(const Document& d) :
