...
namespace rooset {
  ...
  class AreaDelegationUnsetEvent : public ProjectEvent<Document>
  {
  private:
    const string MESSAGE_TYPE = "AREA_DELEGATION_UNSET_EVENT";
  ...
  public:
    ...
    const uuid id;
        ...
        AreaDelegationUnsetEvent(const Document& d) :
