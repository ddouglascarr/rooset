...
namespace rooset {
  ...
  class AreaConcernRemovedEvent : public ProjectEvent<Document>
  {
  private:
    const string MESSAGE_TYPE = "AREA_CONCERN_REMOVED_EVENT";
  ...
  public:
    ...
    const uuid id;
        ...
        AreaConcernRemovedEvent(const Document& d) :
    ...
    AreaConcernRemovedEvent(const RemoveAreaConcernCommand& c):
        id(c.id),
areaId(c.areaId),
