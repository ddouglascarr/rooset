...
namespace rooset {
  ...
  class PolicyDeactivatedEvent : public ProjectEvent<Document>
  {
  private:
    const string MESSAGE_TYPE = "POLICY_DEACTIVATED_EVENT";
  ...
  public:
    ...
    const uuid id;
        ...
        PolicyDeactivatedEvent(const Document& d) :
    ...
    PolicyDeactivatedEvent(const DeactivatePolicyCommand& c):
        id(c.id),
