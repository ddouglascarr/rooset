...
namespace rooset {
  ...
  class AreaConcernAddedEvent : public ProjectEvent<Document>
  {
  private:
    const string MESSAGE_TYPE = "AREA_CONCERN_ADDED_EVENT";
  ...
  public:
    ...
    const uuid id;
        ...
        AreaConcernAddedEvent(const Document& d) :
    ...
    AreaConcernAddedEvent(const AddAreaConcernCommand& c):
        id(c.id),
areaId(c.areaId),
