...
namespace rooset {
  ...
  class AddAreaConcernCommand : public ProjectCommand<Document>
  {
  private:
    const string MESSAGE_TYPE = "ADD_AREA_CONCERN_COMMAND";
  ...
  public:
    ...
    const uuid id;
        ...
        AddAreaConcernCommand(const Document& d) :
