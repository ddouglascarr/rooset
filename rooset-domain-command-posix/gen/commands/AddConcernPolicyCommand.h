...
namespace rooset {
  ...
  class AddConcernPolicyCommand : public ProjectCommand<Document>
  {
  private:
    const string MESSAGE_TYPE = "ADD_CONCERN_POLICY_COMMAND";
  ...
  public:
    ...
    const uuid id;
        ...
        AddConcernPolicyCommand(const Document& d) :
