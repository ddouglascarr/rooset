...
namespace rooset {
  ...
  class DeactivatePolicyCommand : public ProjectCommand<Document>
  {
  private:
    const string MESSAGE_TYPE = "DEACTIVATE_POLICY_COMMAND";
  ...
  public:
    ...
    const uuid id;
        ...
        DeactivatePolicyCommand(const Document& d) :
