...
TEST(concern_tests, a_non_manager_cannot_add_a_policy_to_a_concern_command)
{
  ...
  auto cmd_doc = JsonUtils::parse(u8R"json({
  "type": "ADD_CONCERN_POLICY_COMMAND",
  "payload": {
    "id": "464b1ebb-32c1-460c-8e9e-000000000000",
    "requesterId": "464b1ebb-32c1-460c-8e9f-000000000000",
    "policyId": "464b1ebb-32c1-460c-8e9e-888888888888",
  ...
  try {
  JsonUtils::validate(AddConcernPolicyCommand::schema, cmd_doc);
  } catch (invalid_argument e) {
    throw invalid_argument("cmd schema invalid");
  }
  AddConcernPolicyCommand cmd(cmd_doc);
...
TEST(concern_tests, a_manager_cannot_add_a_non_active_policy_to_a_concern_command)
{
...
TEST(concern_tests, a_manager_can_add_a_policy_to_a_concern)
{
  ...
  try {
  JsonUtils::validate(ConcernPolicyAddedEvent::schema, expected_doc);
  } catch (invalid_argument e) {
    throw invalid_argument("expected schema invalid");
  }
  ConcernPolicyAddedEvent expected(expected_doc);
...
TEST(concern_tests, a_manager_cannot_add_a_policy_to_a_concern_that_has_already_been_added)
{
...
TEST(concern_tests, a_manager_can_remove_a_policy_from_a_concern)
{
  ...
  auto expected_doc = JsonUtils::parse(u8R"json({
  "type": "CONCERN_POLICY_REMOVED_EVENT",
  "payload": {
    "id": "464b1ebb-32c1-460c-8e9e-000000000000",
    "requesterId": "464b1ebb-32c1-460c-8e9e-111111111111",
    "policyId": "464b1ebb-32c1-460c-8e9e-888888888888",
  ...
  try {
  JsonUtils::validate(ConcernPolicyRemovedEvent::schema, expected_doc);
  } catch (invalid_argument e) {
    throw invalid_argument("expected schema invalid");
  }
  ConcernPolicyRemovedEvent expected(expected_doc);
  
  auto cmd_doc = JsonUtils::parse(u8R"json({
  "type": "REMOVE_CONCERN_POLICY_COMMAND",
  "payload": {
    "id": "464b1ebb-32c1-460c-8e9e-000000000000",
    "requesterId": "464b1ebb-32c1-460c-8e9e-111111111111",
    "policyId": "464b1ebb-32c1-460c-8e9e-888888888888",
  ...
  try {
  JsonUtils::validate(RemoveConcernPolicyCommand::schema, cmd_doc);
  } catch (invalid_argument e) {
    throw invalid_argument("cmd schema invalid");
  }
  RemoveConcernPolicyCommand cmd(cmd_doc);
...
TEST(concern_tests, a_manager_cannot_remove_a_policy_from_a_concern_if_it_has_already_been_removed)
{
