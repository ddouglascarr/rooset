...
module.exports = function(exceptionType) {
  const classTypename = generateClassnameFromMsgType(exceptionType);
...
namespace rooset {
  ...
  class ${classTypename} : public ProjectException<Document>
  {
  private:
    const string msg;
