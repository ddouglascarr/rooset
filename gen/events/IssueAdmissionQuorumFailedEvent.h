...
namespace rooset {
  ...
  class IssueAdmissionQuorumFailedEvent : public ProjectEvent<Document>
  {
  private:
    const string MESSAGE_TYPE = "ISSUE_ADMISSION_QUORUM_FAILED_EVENT";
  ...
  public:
    ...
    const uuid id;
        ...
        IssueAdmissionQuorumFailedEvent(
            uuid id) :
            id(id) 
        {}
        ...
        IssueAdmissionQuorumFailedEvent(const Document& d) :
