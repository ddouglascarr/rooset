...
namespace rooset {
  ...
  class AreaDelegationSetEvent : public ProjectEvent<Document>
  {
  private:
    const string MESSAGE_TYPE = "AREA_DELEGATION_SET_EVENT";
  ...
  public:
    ...
    const uuid id;
        ...
        AreaDelegationSetEvent(const Document& d) :
