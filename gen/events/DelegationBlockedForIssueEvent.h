...
namespace rooset {
  ...
  class DelegationBlockedForIssueEvent : public ProjectEvent<Document>
  {
  private:
    const string MESSAGE_TYPE = "DELEGATION_BLOCKED_FOR_ISSUE_EVENT";
  ...
  public:
    ...
    const uuid id;
        ...
        DelegationBlockedForIssueEvent(const Document& d) :
