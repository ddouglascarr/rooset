...
namespace rooset {
  ...
  class RemoveConcernPolicyCommand : public ProjectCommand<Document>
  {
  private:
    const string MESSAGE_TYPE = "REMOVE_CONCERN_POLICY_COMMAND";
  ...
  public:
    ...
    const uuid id;
        ...
        RemoveConcernPolicyCommand(const Document& d) :
