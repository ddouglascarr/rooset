...
namespace rooset {
  ...
  class ConcernPolicyRemovedEvent : public ProjectEvent<Document>
  {
  private:
    const string MESSAGE_TYPE = "CONCERN_POLICY_REMOVED_EVENT";
  ...
  public:
    ...
    const uuid id;
        ...
        ConcernPolicyRemovedEvent(const Document& d) :
    ...
    ConcernPolicyRemovedEvent(const RemoveConcernPolicyCommand& c):
        id(c.id),
