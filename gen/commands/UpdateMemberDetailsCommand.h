...
namespace rooset {
  ...
  class UpdateMemberDetailsCommand : public ProjectCommand<Document>
  {
  private:
    const string MESSAGE_TYPE = "UPDATE_MEMBER_DETAILS_COMMAND";
  ...
  public:
    ...
    const uuid id;
        ...
        UpdateMemberDetailsCommand(const Document& d) :
