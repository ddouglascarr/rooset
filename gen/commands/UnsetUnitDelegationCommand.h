...
namespace rooset {
  ...
  class UnsetUnitDelegationCommand : public ProjectCommand<Document>
  {
  private:
    const string MESSAGE_TYPE = "UNSET_UNIT_DELEGATION_COMMAND";
  ...
  public:
    ...
    const uuid id;
        ...
        UnsetUnitDelegationCommand(const Document& d) :
