...
namespace rooset {
  ...
  class UnsetIssueDelegationCommand : public ProjectCommand<Document>
  {
  private:
    const string MESSAGE_TYPE = "UNSET_ISSUE_DELEGATION_COMMAND";
  ...
  public:
    ...
    const uuid id;
        ...
        UnsetIssueDelegationCommand(const Document& d) :
