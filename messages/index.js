...
$root.messages = (function() {
     ...
     */
    messages.FieldAuth = (function() {
        var valuesById = {}, values = Object.create(valuesById);
        values[valuesById[0] = "NotRequired"] = 0;
        values[valuesById[1] = "JWTAuthRequired"] = 1;
        return values;
    })();
...
$root.google = (function() {
    ...
    google.protobuf = (function() {
        ...
        protobuf.FieldOptions = (function() {
             ...
             * @property {messages.FieldAuth|null} [".messages.auth"] FieldOptions .messages.auth
             */
            ...
            /**
             * FieldOptions .messages.auth.
             * @member {messages.FieldAuth} .messages.auth
             * @memberof google.protobuf.FieldOptions
             * @instance
             */
            FieldOptions.prototype[".messages.auth"] = 0;
            ...
            FieldOptions.verify = function verify(message) {
                ...
                if (message[".messages.auth"] != null && message.hasOwnProperty(".messages.auth"))
                    switch (message[".messages.auth"]) {
                    default:
                        return ".messages.auth: enum value expected";
                    case 0:
                    case 1:
                        break;
                    }
            ...
            FieldOptions.fromObject = function fromObject(object) {
                ...
                switch (object[".messages.auth"]) {
                case "NotRequired":
                case 0:
                    message[".messages.auth"] = 0;
                    break;
                case "JWTAuthRequired":
                case 1:
                    message[".messages.auth"] = 1;
                    break;
                }
                return message;
            };
            ...
            FieldOptions.toObject = function toObject(message, options) {
                ...
                if (options.defaults) {
                    ...
                    object.weak = false;
                    object[".messages.auth"] = options.enums === String ? "NotRequired" : 0;
                }
                if (message.ctype != null && message.hasOwnProperty("ctype"))
                ...
                if (message[".messages.auth"] != null && message.hasOwnProperty(".messages.auth"))
                    object[".messages.auth"] = options.enums === String ? $root.messages.FieldAuth[message[".messages.auth"]] : message[".messages.auth"];
                return object;
            };
