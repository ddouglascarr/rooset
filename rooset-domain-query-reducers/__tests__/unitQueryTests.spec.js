...
describe("Unit Query Tests", () => {
  ...
  afterEach(() => {
    ...
    it("Query active unit", () => {
      ...
      .then(function(body) {
        expect(body).toEqual({"id":"464b1ebb-32c1-460c-8e9e-000000000000","name":"Test Unit","description":"The Test Unit","policies":[{"policyId":"464b1ebb-32c1-460c-8e9e-333333333333","name":"Test Policy","description":"The Test Policy","votingAlgorithm":"SCHULZE","maxAdmissionTime":604800000,"minAdmissionTime":0,"discussionTime":604800000,"verificationTime":604800000,"votingTime":604800000,"issueQuorumNum":1,"issueQuorumDen":10,"initiativeQuorumNum":1,"initiativeQuorumDen":10}],"areas":[{"areaId":"464b1ebb-32c1-460c-8e9e-111111111111","name":"area0","description":"The 0 Area","externalReference":"http://area0.org"},{"areaId":"464b1ebb-32c1-460c-8e9e-222222222222","name":"area1","description":"The 1 Area","externalReference":"http://area1.org"}]});
        return Promise.resolve();
      });
    });
